  ...
  <div class="content-wrapper p-4">
    <div class="card card-primary shadow-lg">
      <div class="card-header">
        <h3 class="card-title"><i class="fas fa-bullhorn mr-2"></i>Create a New Announcement</h3>
      </div>
      <div class="card-body">
        <?php if ($message) {
          echo $message;
          if (strpos($message, 'success')) {
            echo "<script>document.addEventListener('DOMContentLoaded', confettiRain);</script>";
          }
        } ?>
        <form action="?page=post_announcement" method="POST">
          <div class="form-group">
            <label for="title">Announcement Title</label>
            <input type="text" class="form-control" id="title" name="title" placeholder="Enter a clear and concise title" required>
          </div>
          <div class="form-group">
